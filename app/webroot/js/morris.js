(function() {
  ...
  Morris.Line = (function() {
	...
	Line.prototype.drawHover = function() {
      ...
      this.hoverHeight = this.options.hoverFontSize * 1.5 * (this.series.length + 1) + 6;
      ...
      this.xLabel = this.r.text(0, (this.options.hoverFontSize * 0.75) + 26 - this.hoverHeight / 2, '').attr('fill', this.options.hoverLabelColor).attr('font-size', this.options.hoverFontSize);
      ...
      for (i = _i = 0, _ref = this.series.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        yLabel = this.r.text(0, this.options.hoverFontSize * 1.5 * (i + 1.5) - 13 - this.hoverHeight / 2, '').attr('fill', this.options.hoverValueColor).attr('font-weight', 'bold').attr('font-size', this.options.hoverXFontSize);
...
*/
    Line.prototype.updateHover = function(index) {
      ...
      for (i = _i = 0, _ref = this.series.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        this.yLabels[i].attr('text', (this.yLabelFormat(this.series[i][index])));
